...
There are times when you prefer to just compile Amber code to a script, for example when dealing with _cron jobs_ or deploying to environments without Amber installed:
...
| Icon | Name | Location |
|---|:----:|:-----:|
| LOGO:emacs | **Emacs** | [Amber mode extension](https://codeberg.org/GeorgGD/amber-mode) |
...
| LOGO:vsc | **VS Code** | [VSC Marketplace](https://marketplace.visualstudio.com/items?itemName=amber-lsp-publisher.amber-lsp) or [Our extension repository](https://github.com/amber-lang/amber-lsp) |
